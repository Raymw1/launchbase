...
routes.get("/", getUser, chefs.index); // Mostrar a lista de receitas
routes.get("/create", getUser, chefs.create); // Mostrar formulário de nova receita
routes.get("/:id", getUser, chefs.show); // Exibir detalhes de uma receita
routes.get("/:id/edit", getUser, chefs.edit); // Mostrar formulário de edição de receita
