...
module.exports = {
  async post(req, res, next) {
    ...
    if (noImage) return res.render("admin/recipes/create", { files: req.files, recipe: req.body, chefs, error: "Insira pelo menos uma imagem!"});
    ...
    if (emptyFields) return res.render("admin/recipes/create", { ...data, chefs});
    next()
  },
